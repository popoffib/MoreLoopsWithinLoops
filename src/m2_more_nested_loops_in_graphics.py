...
def draw_upside_down_wall(rectangle, n, window):
    ...
    for k in range(n):
        for j in range(k + 1):
            ...
            window.render(0.1)
            corner1.x = new_rectangle.corner_1.x + width
            corner2.x = new_rectangle.corner_2.x + width
        corner1.y = corner1.y - height
        corner2.y = corner2.y - height
        corner1.x = corner1.x - width * (k + 1) - (width / 2)
        corner2.x = corner2.x - width * (k + 1) - (width / 2)

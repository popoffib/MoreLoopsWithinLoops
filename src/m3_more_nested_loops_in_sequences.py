...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 45
    answer = largest_number(([-3], [45], [13], [5], [34], [9]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = -1
    answer = largest_negative_number(([-1], [-5], [-3], [-54]))
    print('Expected and actual are:', expected, answer)

    # Test 2:
    expected = -4
    answer = largest_negative_number(([-5], [-4], [-7]))
    print('Expected and actual are:', expected, answer)

    # Test 3:
    expected = -3
    answer = largest_negative_number(([5], [-7], [-17], [-3], [45], [-9]))
    print('Expected and actual are:', expected, answer)
